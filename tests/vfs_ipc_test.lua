--[[
  KNUCK VFS + IPC userspace test
  ==============================
  Manual test program (NOT part of boot). Exercises the VFS (files, dirs,
  symlinks, /proc, /sys, /dev) and IPC (pipe, select, AF_UNIX socket,
  mkfifo). Run manually:
    lua /knuck/tests/vfs_ipc_test.lua
]]
